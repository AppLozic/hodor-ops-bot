...
public class BroadcastService {
    ...
    public static void sendVideoCallAnswered(Context context,String action){

        Log.i(TAG, "Sending  Broadcast for video call answered ......");
        Intent intent = new Intent();
        intent.setAction(action);
        intent.addCategory(Intent.CATEGORY_DEFAULT);
        sendBroadcast(context, intent);
    ...
    public static void sendVideoRejected(Context context,String action){

        Log.i(TAG, "Sending  Broadcast for video rejected ......");
        Intent intent = new Intent();
        intent.setAction(action);
        intent.addCategory(Intent.CATEGORY_DEFAULT);
        sendBroadcast(context, intent);
    ...
    public static IntentFilter getIntentFilter() {
        ...
        //// VIDEO CALL BROADCASTS /////////
        intentFilter.addAction(INTENT_ACTIONS.VIDEO_CALL_ANSWERED.toString());
        intentFilter.addAction(INTENT_ACTIONS.VIDEO_CALL_REJECT.toString());
    ...
    public enum INTENT_ACTIONS {
        ...
        CONTACT_VERIFIED, NOTIFY_USER, MQTT_DISCONNECTED,UPDATE_NAME,VIDEO_CALL_ANSWERED,VIDEO_CALL_REJECT
    }
