...
*/
  ...
  /*@Override
    ...
    public enum ContentType {
        ...
        ,VIDEO_MSG(Short.valueOf("9")),CHANNEL_CUSTOM_MESSAGE(Short.valueOf("10")), CUSTOM(Short.valueOf("101")), VIDEO_CALL_NOTIFICATION_MSG(Short.valueOf("102")),
        VIDEO_CALL_STATUS_MSG(Short.valueOf("103")),HIDDEN(Short.valueOf("11"));
        private Short value;
